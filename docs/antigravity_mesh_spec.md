...
> **Синхронизировано:** `2026-09-06T16:10:25.474770+00:00` | **Источник:** Автоматический аудит ядра хоста
...
- **ОЗУ:** 2464 MB всего | **Свободно/Доступно:** 367 MB
- **Диск `/`:** 38.06 GB всего | **Занято:** 89.0% (2.48 GB свободно)

### Ключевые активные службы на основном сервере:
- 🟢 `omniroute.service`: **active**
- 🟢 `nginx.service`: **active**
- 🟢 `agy-webhook.service`: **active**
- 🟢 `agy-watcher.service`: **active**
